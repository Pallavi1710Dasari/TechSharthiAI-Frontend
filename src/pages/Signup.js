  ...
  return (
    <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', height: '80vh', marginTop:"50px", backgroundColor: '#f5f5f5' }}>
      <div style={{ backgroundColor: '#fff', borderRadius: '10px', boxShadow: '0px 0px 10px rgba(0, 0, 0, 0.1)', padding: '20px', width: '350px', textAlign: 'center' }}>
        ...
        <Typography component="h1" variant="h5" style={{ fontSize: '20px', fontWeight: '600', color: '#000', marginBottom: '5px' }}>
        Math Sharthi / SignUp
        </Typography>
        ...
        <form onSubmit={handleSignup} style={{ marginBottom: '10px' }}>
          ...
          <Button fullWidth variant="contained" color="primary" type="submit" style={{ marginTop: '10px', backgroundColor: '#a78bfa' }}>Sign Up</Button>
        </form>
        <Button style={{ width: '100%', backgroundColor: '#4285f4', color: 'white', marginBottom: '10px' }}>
          <FaGoogle style={{ marginRight: '8px' }} />
          Sign in with Google
        </Button>
        <Button onClick={handleLoginRedirect} style={{ width: '100%', backgroundColor: '#a78bfa', color: 'white', marginBottom: '10px' }}>
